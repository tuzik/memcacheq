...
pkgdatadir = $(datadir)/memcacheq
pkglibdir = $(libdir)/memcacheq
pkgincludedir = $(includedir)/memcacheq
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/configure AUTHORS ChangeLog INSTALL TODO compile \
...
memcacheq$(EXEEXT): $(memcacheq_OBJECTS) $(memcacheq_DEPENDENCIES) 
